...
<div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">{{ $title_table ? 'Manutenções' : '-' }}</li>
      </ol>
    </nav>
</div>
<!-- End Page Title -->
          ...
          <div class="card-body">
            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                ...
                <div class="row mb-4">
                  ...
                  <div class="col-lg-9 col-md-8">{{ $data->gadgets->name ?? '-' }}</div>
                </div>

                <div class="row mb-4">
                  <div class="col-lg-3 col-md-4 label fw-bold">Intervalo</div>
                  <div class="col-lg-9 col-md-8">{{ $data->interval ?? '-' }}</div>
                </div>
                ...
                <div class="row mb-4">
                    <div class="col-lg-3 col-md-4 label fw-bold">Data do Agendamento</div>
                    <div class="col-lg-9 col-md-8">{{ date("d/m/Y", strtotime($data->date)) ?? '-' }} </div>
                  </div>
