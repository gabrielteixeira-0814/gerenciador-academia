        ...
        <div class="card">
          <div class="card-body">
            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                ...
                <h5 class="card-title">Detalhes do Tipo do Cliente</h5>
                ...
                <div class="row mb-4">
                    <div class="col-lg-3 col-md-4 label fw-bold">Descrição</div>
                    <div class="col-lg-9 col-md-8">{{ $data->description ?? '-' }}</div>
                </div>

                <div class="row mb-4">
                    <div class="col-lg-3 col-md-4 label fw-bold">Quantidade</div>
                    <div class="col-lg-9 col-md-8">{{ $data->quantity ?? '-' }}</div>
                </div>
