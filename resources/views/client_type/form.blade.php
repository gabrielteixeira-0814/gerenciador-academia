      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            ...
            @endif
            <form action="{{ !isset($data) ? route('client_type.store') : route('client_type.update', $data->id)}}" method="POST" class="row g-3 justify-content-center">
                @if (!isset($data))
                    @method('POST')
                @else
                    @method('PUT')
                ...
                <div class="col-7">
                    ...
                    <input type="text" name="type" class="form-control" id="type" value="{{ isset($data) != '' ? $data->type :  old('type') }}">
                </div>
